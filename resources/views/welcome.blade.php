...
<head>
    ...
    <link href="https://fonts.bunny.net/css?family=instrument-sans:400,500,600&family=plus-jakarta-sans:400,500,600,700" rel="stylesheet" />
    <!-- Styles -->
...
<body class="bg-white dark:bg-gray-900 min-h-screen flex flex-col">
    <!-- Navbar -->
    <nav class="bg-white dark:bg-gray-800/95 backdrop-blur-md shadow-md fixed w-full top-0 z-50 border-b border-gray-200/20 dark:border-gray-700/20">
    ...
    <header class="hero-gradient relative pt-20 pb-32 text-white overflow-hidden">
        <div class="absolute inset-0 opacity-10">
            ...
            <div class="absolute top-0 -right-4 w-72 h-72 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl"></div>
        </div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <div class="mb-6 inline-block">
                <span class="inline-flex items-center rounded-full bg-white/20 px-4 py-2 text-sm font-medium text-white backdrop-blur-sm border border-white/30">
                    ✨ Welcome to smarter rental living
                </span>
            </div>
            <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
                Find Your <span class="block text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-cyan-200">Perfect Rental</span>
            </h1>
    ...
    <section id="features" class="py-24 bg-gray-50 dark:bg-gray-800/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">Everything you need for a seamless rental experience</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="feature-card bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 shadow-sm">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                        Every property is carefully verified for authenticity and quality. We ensure only legitimate listings are available.
                    </p>
                </div>
                <div class="feature-card bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 shadow-sm">
                    <div class="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-xl flex items-center justify-center mb-6 shadow-lg">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                        Pay safely with multiple trusted payment methods. Your financial information is always protected.
                    </p>
                </div>
                <div class="feature-card bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 shadow-sm">
                    <div class="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-xl flex items-center justify-center mb-6 shadow-lg">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                        Our dedicated support team is always here to help. Get answers quickly whenever you need assistance.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="flex gap-6 min-w-min">
                        @foreach ($properties as $property)
                            <div
                                ...
                                <div class="p-5">
                                    <h3 class="font-bold text-gray-900 dark:text-white text-base mb-2 line-clamp-2 h-14">
                                        {{ $property->title }}
                                    </h3>
                                    ...
                                    <div class="flex flex-wrap gap-3 text-sm text-gray-600 dark:text-gray-400 border-t border-gray-100 dark:border-gray-700 pt-4">
            ...
            @else
                <div class="text-center py-16">
                    <svg class="w-16 h-16 text-gray-300 dark:text-gray-600 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 12a9 9 0 109 9m0 0l3-3m-3 3l-3-3" />
                    </svg>
    ...
    <section class="py-16 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-blue-50 mb-8">Join thousands of satisfied renters exploring properties on our platform.</p>
            <a href="{{ route('properties.index') }}"
    ...
    <footer class="bg-gray-900 dark:bg-gray-950 text-gray-400 py-12 border-t border-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-500 mb-4 md:mb-0">&copy; {{ date('Y') }} {{ config('app.name') }}. All rights reserved.</p>
