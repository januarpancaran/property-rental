                ...
                <div class="p-6">
                    @if ($bookings->count() > 0)
                        <div class="space-y-6">
                            @foreach ($bookings as $booking)
                                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden hover:shadow-lg transition-all duration-200">
                                    <div class="flex flex-col md:flex-row gap-0">
                                        ...
                                        <div class="flex-grow p-6">
                                            ...
                                            <div class="flex flex-wrap justify-end gap-2 pt-4 border-t border-gray-200 dark:border-gray-700">
                                                @if ($booking->booking_status === 'pending' && $booking->payment_status === 'unpaid')
                                                    ...
                                                    @elseif($booking->order && $booking->order->isExpired())
                                                        <span class="px-4 py-2 bg-gray-400 text-white font-medium rounded-lg text-sm cursor-not-allowed">
                                                            Payment Expired
                                                        </span>
                                                    @else
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-500 dark:text-gray-400 mt-4 text-lg font-medium">You haven't made any bookings yet.</p>
                            <p class="text-gray-400 dark:text-gray-500 text-sm mt-2 mb-6">Start exploring properties and make your first booking!</p>
