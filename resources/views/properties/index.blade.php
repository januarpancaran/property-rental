<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Filters -->
            <div
                class="bg-gradient-to-r from-indigo-50 to-white dark:from-gray-800 dark:to-gray-800 overflow-hidden shadow-sm rounded-lg mb-6 border border-indigo-100 dark:border-gray-700">
                <div class="p-6">
                    ...
                    <form method="GET" action="{{ route('properties.index') }}" id="filterForm">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                            ...
                            <div class="relative">
                                ...
                                @if (request('city'))
                                    <button type="button"
                                        onclick="document.querySelector('input[name=city]').value=''; document.getElementById('filterForm').submit();"
                            ...
                            <div>
                                ...
                                <select name="property_type"
                                    ...
                                    <option value="studio"
                                        {{ request('property_type') == 'studio' ? 'selected' : '' }}>Studio</option>
                                </select>
                            </div>
                ...
                <div class="p-6">
                    @if ($properties->count() > 0)
                        @if (request('check_in') && request('check_out'))
                            <div
                                class="mb-6 p-4 bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-200 dark:border-indigo-800 rounded-lg">
                                ...
                                <div
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="flex items-center justify-between mb-4">
                                            ...
                                            <span
                                                class="text-xs px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 rounded-full capitalize">
