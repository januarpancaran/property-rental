            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div>
                            <h3 class="text-lg font-bold mb-4 text-indigo-600 dark:text-indigo-400">Detail Transaksi</h3>
                            <div class="space-y-4">
                                
                                <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    <span class="text-sm text-gray-500 dark:text-gray-400 block mb-1">Total Biaya:</span>
                                ...
                                <div>
                                    ...
                                    <p class="font-medium dark:text-gray-100">{{ optional($booking->property)->title ?? 'N/A' }}</p>
                                </div>
                                
                                <div>
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Tanggal Dibuat:</span>
                                    <p class="font-medium dark:text-gray-100">{{ $booking->created_at->format('d M Y H:i') }}</p>
                                </div>
                                
                                <div>
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Terakhir Diperbarui:</span>
                                    <p class="font-medium dark:text-gray-100">{{ $booking->updated_at->format('d M Y H:i') }}</p>
                                </div>
                                
                                <div>
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Catatan:</span>
                                    <p class="font-medium text-gray-700 dark:text-gray-300 italic">{{ $booking->notes ?: 'Tidak ada catatan.' }}</p>
                                </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    @endphp
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium text-white {{ $paymentColor }}">
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="font-medium dark:text-gray-100">{{ optional($booking->user)->id ?? 'N/A' }}</p>
                                </div>
                                <div>
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Nama Lengkap:</span>
                                    <p class="font-medium dark:text-gray-100">{{ $userName ?: 'User Tidak Ditemukan' }}</p>
                                </div>
                                <div>
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Email:</span>
                                    <p class="font-medium dark:text-gray-100">{{ optional($booking->user)->email ?? 'N/A' }}</p>
                                </div>
                                <div>
                                    <span class="text-sm text-gray-500 dark:text-gray-400">No. Kontak:</span>
                                    <p class="font-medium dark:text-gray-100">{{ optional($booking->user)->phone ?? 'N/A' }}</p>
                                </div>
                            </div>
                        </div>
