            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.bookings.store') }}" method="POST">
                        ...
                        @if ($errors->any())
                            <div class="mb-4 p-4 border border-red-300 bg-red-50 dark:bg-red-900 dark:border-red-700 rounded-md text-red-700 dark:text-red-300">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div class="col-span-1">
                                <label for="check_in_date"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal Check-in</label>
                            ...
                            <div class="col-span-1">
                                <label for="check_out_date"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal Check-out</label>
                        ...
                        <div class="mb-8">
                            <label for="notes"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Catatan (Notes)</label>
