                                ...
                                <tr class="transition-all duration-200 hover:bg-blue-50/30 dark:hover:bg-blue-950/20">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @php
                                            ...
                                            $config = $priorityConfig[$maintenance->priority] ?? [
                                                'color' => 'gray',
                                                'icon' => '⚪',
                                            ];
                                        @endphp
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @php
                                            ...
                                            $config = $statusConfig[$maintenance->status] ?? [
                                                'color' => 'gray',
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="font-semibold text-gray-600 dark:text-gray-400 mb-1">No requests
                                                yet
                                            </p>
