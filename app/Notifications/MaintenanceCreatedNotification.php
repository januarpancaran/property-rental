...
class MaintenanceCreatedNotification extends Notification
{
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => 'A new maintenance request has been submitted for your property: ' . $this->maintenance->property->title,
            'action_url' => url()->route('manage.maintenances.show', $this->maintenance, false),
        ];
    }
}
